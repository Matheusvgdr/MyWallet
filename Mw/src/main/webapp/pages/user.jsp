	...
	<nav class="sidebar close">
		...
		<div class="menu-bar">
			<div class="menu">
				...
				<ul class="menu-links">
					...
					<li class="nav-link"><a href="transactions.jsp"> <i
							...
							class="text nav-text">Withdraw money</span>
					</a></li>
			...
			<div class="bottom-content">
				<li class=""><a href="../index.html"> <i id="logOut"
		...
		<div class="info">
			...
			<div class="container_info">
				...
				<div class="container_icons">
					<a href="../PrepareModificationServlet?id=<%=usr.getId()%>"
						id="edit"><i class='bx bx-edit icon '></i></a> <a href="#"
						onclick="confirmDeleteUser(<%=usr.getId()%>)"><i
						class='bx bx-x-circle icon '></i></a>
				</div>
		...
		<div class="modification">
			...
			<form action="../ModifyUserServlet" method="post">
				...
				<div class="input-data">
					...
					<input type="text" value="<%=us.getPersonName()%>"
						name="personName" id="personName" autocomplete="off" required>
					<div class="underline"></div>
				...
				<div class="input-data">
					...
					<input type="text" value="<%=us.getUserName()%>" name="userName"
				...
				<div class="input-data">
					...
					<input type="text" value="<%=us.getUserPassword()%>"
						name="userPassword" id="userPassword" autocomplete="off" required>
					<div class="underline"></div>
				...
				<div class="input-data">
					...
					<input type="text" value="<%=us.getCpf()%>" name="cpf" id="cpf"
